...
public class GestionUsuariosController {
    ...
    private void manejarVerUsuarios() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoalpha/VerUsuarios.fxml"));
    ...
    private void manejarEliminarUsuario() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoalpha/EliminarUsuario.fxml"));
            Parent root = loader.load();
    ...
    private void manejarCrearUsuario() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoalpha/CrearUsuario.fxml"));
            Parent root = loader.load();
    ...
    private void manejarActualizarUsuarios() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoalpha/ActualizarUsuarios.fxml"));
            Parent root = loader.load();
    ...
    private void manejarVolver() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoalpha/MenuAdministrador.fxml"));
            Parent root = loader.load();
